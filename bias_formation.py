...
zstar=np.array([[0, -5],[0, 5],[-5, 0],[5, 0]])
...
Bias=np.array([2,0,2,0,0,0,0,0]) #El robot 1 mete un error de 0.5 
...
error[2]=-error[0]
error[3]=-error[1]
error[4]=posiciones[0,nptos-1]-posiciones[4,nptos-1]
error[5]=posiciones[1,nptos-1]-posiciones[5,nptos-1]
error[6]=-error[4]
error[7]=-error[6]
